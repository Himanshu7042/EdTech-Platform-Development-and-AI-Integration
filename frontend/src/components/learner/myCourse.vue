<template>
    <div class="my-courses">
      ...
      <div class="content">
        <button class="use-ai-tutor" @click="useAiTutor()">Use AI Tutor</button>
    ...
    methods: {
      ...
      async fetchCourses() {
        try {
          ...
          const response = await axiosFetch.get('/api/learner/my-courses', { params: { username: this.username } });
      ...
      goToCoursePage(courseId, courseName) {
        ...
        this.$router.push({ name: 'learner', params: { courseId: courseId, courseName:courseName } })
      },
      useAiTutor(){
